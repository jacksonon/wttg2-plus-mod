...
public class TitleManager : MonoBehaviour
{
	...
	private void Awake()
	{
		...
		foreach (TextMeshProUGUI textMesh in UnityEngine.Object.FindObjectsOfType<TextMeshProUGUI>())
		{
			if (textMesh.gameObject.name == "Ver")
			{
				textMesh.text = "V " + ModsManager.ModVersion;
			}
		}
	}
	...
	{
		Transform transform = GameObject.Find("NuidtyTitle").transform;
		Transform transform3 = GameObject.Find("GameOptions").transform;
		Transform transform2 = GameObject.Find("Logo").transform;
		float floatA = 0f;
		float floatB = 0f;
		...
		gameObject.transform.position = new Vector2(transform.position.x - floatA, transform.position.y - floatB);
		...
		gameObject2.transform.position = new Vector2(transform.position.x - floatA, transform.position.y - floatB - 50f);
		...
		gameObject3.transform.position = new Vector2(transform.position.x - floatA, transform.position.y - floatB - 100f);
		...
		gameObject4.transform.position = new Vector2(transform.position.x - floatA, transform.position.y - floatB - 150f);
		...
		gameObject4.transform.SetParent(transform2);
		GameObject gameObject5 = UnityEngine.Object.Instantiate<GameObject>(GameObject.Find("NuidtyTitle"));
		gameObject5.name = "modmenu5";
		gameObject5.transform.position = new Vector2(transform.position.x - floatA, transform.position.y - floatB - 200f);
		...
		gameObject6.transform.position = new Vector2(transform.position.x - floatA, transform.position.y - floatB - 250f);
		...
		gameObject6.transform.SetParent(transform2);
		GameObject gameObject7 = UnityEngine.Object.Instantiate<GameObject>(GameObject.Find("NuidtyTitle"));
		gameObject7.name = "modmenu7";
		gameObject7.transform.position = new Vector2(transform.position.x - floatA, transform.position.y - floatB - 300f);
		...
		gameObject7.transform.SetParent(transform2);
		GameObject gameObject8 = UnityEngine.Object.Instantiate<GameObject>(GameObject.Find("NuidtyTitle"));
		gameObject8.name = "modmenu8";
		gameObject8.transform.position = new Vector2(transform.position.x - floatA, transform.position.y - floatB - 350f);
		...
		gameObject8.transform.SetParent(transform2);
	}
